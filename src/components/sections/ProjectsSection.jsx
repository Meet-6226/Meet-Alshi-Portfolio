      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
        {PROJECTS.map((project) => (
          <div 
            ...
            className="bg-[#090909] border border-[#242424] p-8 rounded-[2px] flex flex-col justify-between min-h-[340px] group transition-all duration-300 hover:-translate-y-[3px] hover:border-[#3A3A32] relative overflow-hidden cursor-pointer shadow-none"
          >
            ...
            {/* Metadata Row: Role & Outcome */}
            <div className="grid grid-cols-2 gap-4 py-3 border-t border-[#242424]/60 font-mono text-xs uppercase text-[#8A8A86]">
              <div>
                <span className="text-[#5F5F5B] block text-[11px] mb-0.5">ROLE</span>
                <span className="text-[#F2F2F0] font-semibold">{project.role}</span>
              </div>
              <div>
                <span className="text-[#5F5F5B] block text-[11px] mb-0.5">RECOGNITION</span>
                <span className="text-[#A6B84A] font-bold">{project.status}</span>
              </div>
            </div>

            {/* Bottom Row: Tech Tags & VIEW PROJECT Action */}
